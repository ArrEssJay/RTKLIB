...
typedef struct {        /* observation data */
    ...
    int tm_missed_flag; /* missed tm flag */
...
typedef struct {        /* RTCM control struct type */
    ...
    int curr_msg_type; /* Current decoded message type, -1: no msg; >= 0: see RTCM3 doc */
} rtcm_t;
...
EXPORT int lambda_search(int n, int m, const double *a, const double *Q,
                         double *F, double *s);
EXPORT double ratioinv(double fRate, int n);
